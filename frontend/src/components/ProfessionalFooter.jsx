        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 mb-8">
              <li>
                <a href="mailto:info@alfaglobalgroup.com" className="text-sm text-slate-300 hover:text-amber-400 transition-colors font-light flex items-start">
                  <svg className="w-4 h-4 mr-2 mt-0.5 flex-shrink-0 text-amber-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a href="tel:+911234567890" className="text-sm text-slate-300 hover:text-amber-400 transition-colors font-light flex items-center">
                  <svg className="w-4 h-4 mr-2 flex-shrink-0 text-amber-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link to="/contact" className="text-sm text-slate-300 hover:text-amber-400 transition-colors font-light flex items-center">
                  <svg className="w-4 h-4 mr-2 flex-shrink-0 text-amber-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
