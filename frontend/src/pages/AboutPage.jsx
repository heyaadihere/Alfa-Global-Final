...
const AboutPage = ({ theme = 'teal' }) => {
  ...
  const companies = [
    ...
    { name: 'Dhanveir Groups Shipping', logo: '', desc: 'The Group\'s strategic maritime platform, established to build, own, and operate Indian-flagged vessels across key cargo segments including dry bulk transportation of sand, coal, and minerals.', link: '/dhanveir-groups-shipping' }
  ];
